...
export type PageDiff = {
  page: { id: string; title: string; renamedFrom: string | null };
  shapesAdded: ShapeRef[];
  shapesRemoved: ShapeRef[];
  shapesTextChanged: Array<{ id: string; class: string; before: string; after: string }>;
  shapesClassChanged: Array<{ id: string; before: string; after: string }>;
  linesAdded: LineRef[];
  linesRemoved: LineRef[];
  linesRewired: Array<{ id: string; before: LineEndpoints; after: LineEndpoints }>;
  linesLabelChanged: Array<{ id: string; before: string; after: string }>;
};
